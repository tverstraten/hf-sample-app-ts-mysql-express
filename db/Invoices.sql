...
of 0 and each new state is added with the value increased by 1.',
	...
	PRIMARY KEY (`id`)
	, CONSTRAINT `FK-Invoices-createdBy` FOREIGN KEY (`createdById`) REFERENCES `Users` (`id`)
	, CONSTRAINT `FK-Invoices-lastUpdatedBy` FOREIGN KEY (`lastUpdatedById`) REFERENCES `Users` (`id`)
	, CONSTRAINT `FK-Invoices-withinOrganization` FOREIGN KEY (`withinOrganizationId`) REFERENCES `Organizations` (`id`)
	, CONSTRAINT `FK-Invoices-covering` FOREIGN KEY (`coveringId`) REFERENCES `BillingPeriods` (`id`)
) 
ENGINE=InnoDB,
CHARACTER SET utf8mb4,
COLLATE utf8mb4_general_ci,
COMMENT='One amount charged to an account for a given billing period.';
