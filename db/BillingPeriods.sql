...
of 0 and each new state is added with the value increased by 1.',
	...
	`start` TIMESTAMP NULL COMMENT 'The point in time it started.',
	`end` TIMESTAMP NULL COMMENT 'The point in time it ceased.',
	PRIMARY KEY (`id`)
	, CONSTRAINT `FK-BillingPeriods-createdBy` FOREIGN KEY (`createdById`) REFERENCES `Users` (`id`)
	, CONSTRAINT `FK-BillingPeriods-lastUpdatedBy` FOREIGN KEY (`lastUpdatedById`) REFERENCES `Users` (`id`)
) 
ENGINE=InnoDB,
CHARACTER SET utf8mb4,
COLLATE utf8mb4_general_ci,
COMMENT='A singular interval of time used to bill accounts for.';
