...
export class SubscriptionTypeMetrics implements Nameable, Describable {
	...
	static free = new SubscriptionTypeMetrics(
		"Free",
		"The entry level tier",
		1,
		25
	);
	static pro = new SubscriptionTypeMetrics(
		"Pro",
		"A single active user",
		1,
		500
	);
	static team = new SubscriptionTypeMetrics(
		"Enterprise",
		"A small team of users",
		10,
		5000
	);
	static enterprise = new SubscriptionTypeMetrics(
		"Enterprise",
		"An organization with more than a few users",
		1,
		50
	);
