(function (global, factory) {
  typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('class-transformer'), require('class-validator'), require('reflect-metadata')) :
  typeof define === 'function' && define.amd ? define(['exports', 'class-transformer', 'class-validator', 'reflect-metadata'], factory) :
  (global = global || self, factory(global.typescriptClassValidator = {}, global.classTransformer, global.classValidator));
}(this, function (exports, classTransformer, classValidator) { 'use strict';
                  ...
                  for (let i = 0; i < args.length; i++) {
                      if (indices.indexOf(i) !== -1) {
                          ...
                          if (targets && targets[i]) {
                              ...
                              if (!value) {
                                  const error = new classValidator.ValidationError();
                                  error.constraints = {
  ...
  function getValidationErrors(validatorClass, val, validatorOptions) {
      const data = classTransformer.plainToClass(validatorClass, val);
      const validator = new classValidator.Validator();
