...
exports.TypeScriptClassPropertyToModelHarvester = void 0;
...
class TypeScriptClassPropertyToModelHarvester extends AbstractTypeScriptAstHarvester_1.AbstractTypeScriptAstHarvester {
    constructor(configurationValues) {
        super('TypeScriptClassPropertyToModelHarvester', 'A harvester that infers the data model from typescript classes', {}, configurationValues);
    }
                    ...
                    case typescript_1.SyntaxKind.PropertyDeclaration:
                        ...
                        if (representedClass != null && representedClass.propertiesMap[memberName] == null) {
                            ...
                            try {
                                ...
                                propertyType = ValueType_1.ValueType.fromNameInType(ProgrammingLanguage_1.ProgrammingLanguage.typeScript, 'string');
                            }
...
exports.TypeScriptClassPropertyToModelHarvester = TypeScriptClassPropertyToModelHarvester;
