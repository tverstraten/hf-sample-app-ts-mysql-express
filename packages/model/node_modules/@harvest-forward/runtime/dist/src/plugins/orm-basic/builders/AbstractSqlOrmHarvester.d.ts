...
import { Column, Constraint, Domain, ForeignKey, PrimaryKey, Table, View } from '../../rdbms-basic';
export declare abstract class AbstractSqlOrmHarvester extends AbstractSingularBuilder {
...
//# sourceMappingURL=AbstractSqlOrmHarvester.d.ts.map