...
const Java9LexerBase_js_js_js_js_1 = __importDefault(require("./Java9LexerBase.js.js.js.js"));
...
class Java9Lexer extends Java9LexerBase_js_js_js_js_1.default {
    constructor(input) {
        super(input);
...
exports.default = Java9Lexer;
Java9Lexer.grammarFileName = "Java9Lexer.g4";
Java9Lexer.channelNames = ["DEFAULT_TOKEN_CHANNEL", "HIDDEN"];
Java9Lexer.modeNames = ["DEFAULT_MODE"];
Java9Lexer.literalNames = [null, "'abstract'", "'assert'", "'boolean'", "'break'",
    ...
    "'with'", "'_'", null, null, null, null, null,
    "'null'", "'('", "')'", "'{'", "'}'", "'['", "']'",
    "';'", "','", "'.'", "'...'", "'@'", "'::'", "'='",
    "'>'", "'<'", "'!'", "'~'", "'?'", "':'", "'->'",
    "'=='", "'<='", "'>='", "'!='", "'&&'", "'||'",
...
Java9Lexer.symbolicNames = [null, "ABSTRACT", "ASSERT", "BOOLEAN", "BREAK",
    ...
    "LINE_COMMENT"];
Java9Lexer.ruleNames = ["ABSTRACT", "ASSERT", "BOOLEAN", "BREAK", "BYTE",
    ...
    "OPERNS", "PACKAGE", "PRIVATE", "PROTECTED", "PROVIDES",
    "PUBLIC", "REQUIRES", "RETURN", "SHORT", "STATIC",
    "STRICTFP", "SUPER", "SWITCH", "SYNCHRONIZED", "THIS",
    "THROW", "THROWS", "TO", "TRANSIENT", "TRANSITIVE",
    "TRY", "USES", "VOID", "VOLATILE", "WHILE", "WITH",
    "UNDER_SCORE", "IntegerLiteral", "DecimalIntegerLiteral",
...
Java9Lexer.EOF = antlr4_1.default.Token.EOF;
Java9Lexer.ABSTRACT = 1;
Java9Lexer.ASSERT = 2;
Java9Lexer.BOOLEAN = 3;
Java9Lexer.BREAK = 4;
Java9Lexer.BYTE = 5;
Java9Lexer.CASE = 6;
Java9Lexer.CATCH = 7;
...
Java9Lexer.CLASS = 9;
Java9Lexer.CONST = 10;
Java9Lexer.CONTINUE = 11;
Java9Lexer.DEFAULT = 12;
Java9Lexer.DO = 13;
Java9Lexer.DOUBLE = 14;
Java9Lexer.ELSE = 15;
Java9Lexer.ENUM = 16;
Java9Lexer.EXPORTS = 17;
Java9Lexer.EXTENDS = 18;
Java9Lexer.FINAL = 19;
Java9Lexer.FINALLY = 20;
Java9Lexer.FLOAT = 21;
Java9Lexer.FOR = 22;
Java9Lexer.IF = 23;
Java9Lexer.GOTO = 24;
Java9Lexer.IMPLEMENTS = 25;
Java9Lexer.IMPORT = 26;
Java9Lexer.INSTANCEOF = 27;
Java9Lexer.INT = 28;
Java9Lexer.INTERFACE = 29;
Java9Lexer.LONG = 30;
Java9Lexer.MODULE = 31;
Java9Lexer.NATIVE = 32;
Java9Lexer.NEW = 33;
Java9Lexer.OPEN = 34;
Java9Lexer.OPERNS = 35;
Java9Lexer.PACKAGE = 36;
Java9Lexer.PRIVATE = 37;
Java9Lexer.PROTECTED = 38;
Java9Lexer.PROVIDES = 39;
Java9Lexer.PUBLIC = 40;
Java9Lexer.REQUIRES = 41;
Java9Lexer.RETURN = 42;
Java9Lexer.SHORT = 43;
Java9Lexer.STATIC = 44;
Java9Lexer.STRICTFP = 45;
Java9Lexer.SUPER = 46;
Java9Lexer.SWITCH = 47;
Java9Lexer.SYNCHRONIZED = 48;
Java9Lexer.THIS = 49;
Java9Lexer.THROW = 50;
Java9Lexer.THROWS = 51;
Java9Lexer.TO = 52;
Java9Lexer.TRANSIENT = 53;
Java9Lexer.TRANSITIVE = 54;
Java9Lexer.TRY = 55;
Java9Lexer.USES = 56;
Java9Lexer.VOID = 57;
Java9Lexer.VOLATILE = 58;
Java9Lexer.WHILE = 59;
Java9Lexer.WITH = 60;
...
Java9Lexer.prototype.JavaLetter_sempred = function (localctx, predIndex) {
    switch (predIndex) {
        case 0:
            return Check1();
        case 1:
...
Java9Lexer.prototype.JavaLetterOrDigit_sempred = function (localctx, predIndex) {
    switch (predIndex) {
        case 2:
            return Check3();
        case 3:
