...
exports.AbstractSqlSchemaHarvester = void 0;
...
const RelationalDatabase_1 = require("../RelationalDatabase");
class AbstractSqlSchemaHarvester extends AbstractSingularBuilder_1.AbstractSingularBuilder {
    ...
    async buildInternal(system, __component) {
        ...
        try {
            ...
            if (db == null) {
                db = new RelationalDatabase_1.RelationalDatabase(server, database, '');
                system.addChild(db);
...
exports.AbstractSqlSchemaHarvester = AbstractSqlSchemaHarvester;
