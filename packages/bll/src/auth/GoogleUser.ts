 ...
 */
export interface GoogleUser extends ProviderUser {
	sub: string
	email: string
...
export function GoogleUserFromJson(asJson: any): GoogleUser {
	const asGoogleUser = asJson as GoogleUser

	asGoogleUser.social_id = asGoogleUser.sub
	//asGithubUser.family_name = asGithubUser.family_name ? asGithubUser.family_name : ''
	//asGithubUser.given_name = asGithubUser.given_name ? asGithubUser.given_name : asGithubUser.given_name
	asGoogleUser.avatar_url = asGoogleUser.picture ? asGoogleUser.picture : ''
